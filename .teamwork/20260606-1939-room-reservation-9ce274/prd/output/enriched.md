...
<!-- VISUAL (enrichment, additive): V01 - Banner de status e merge do PRD -->
...
<!-- VISUAL (enrichment, additive): V03 - Mapa de viabilidade A.7 -> B.4 (10 NFRs com veredito) -->
...
<!-- VISUAL (enrichment, additive): V04 - Resumo de reconciliacao de escopo (todos os itens Inalterado) -->
...
<!-- VISUAL (enrichment, additive): V02 - Matriz de risco (probabilidade x impacto) para os 11 riscos consolidados -->
...
<!-- VISUAL (enrichment, additive): V05 - Breakdown de esforco por area (~54 dias-pessoa) -->
...
<!-- VISUAL (enrichment, additive): V06 - Dependencias externas e followups em aberto -->
