...
<!-- VISUAL (enrichment, additive): V01 - Resumo do veredito de viabilidade por NFR (tabela de semaforo) -->
...
<!-- VISUAL (enrichment, additive): V02 - Diagrama C4 de contexto e containers (Mermaid flowchart) -->
...
> Direcao do sync: SISTEMA → Google Calendar (uma via). O Calendar nao retroalimenta o sistema neste release (ADR-003, NFR-02/08, C-Q02).
...
<!-- VISUAL (enrichment, additive): V03 - Mapa de integracoes (Mermaid flowchart) -->
...
<!-- VISUAL (enrichment, additive): V04 - Heatmap/tabela de viabilidade por NFR com sinalizacao de risco e gate -->
...
| NFR-02 | Sync ≤2 min → Calendar | **Com ressalvas** | DISC-001: quotas + credencial |
...
<!-- VISUAL (enrichment, additive): V05 - Matriz de risco tecnico (probabilidade x impacto) dos 6 riscos identificados -->
...
<!-- VISUAL (enrichment, additive): V06 - Lista de ADRs com status e dependencias (tabela de referencia rapida) -->
...
<!-- VISUAL (enrichment, additive): V07 - Distribuicao de esforco por area (grafico de barras Mermaid xychart-beta) -->
...
<!-- VISUAL (enrichment, additive): V08 - Diagrama de estados do ciclo de vida de uma reserva (Mermaid stateDiagram-v2) -->
